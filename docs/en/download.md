...
## Latest version: `v1.15.0` (2026-09-26)

👉 [Release notes and checksums](https://github.com/redtidev1918/DeviantDrop/releases/tag/v1.15.0)

| Platform | File | Size | Download |
|---|---|---|---|
| 通用 | `RELEASE-METADATA.json` | 1 KB | [⬇️ Download](https://github.com/redtidev1918/DeviantDrop/releases/download/v1.15.0/RELEASE-METADATA.json) |
