...
<!-- docsite-release-tag: v1.13.1 -->
# 📥 下载 DeviantDrop

**语言 / Language:** 中文 · [English](/en/download.md)

<!-- docsite: generated from redtidev1918/DeviantDrop release v1.13.1; do not edit by hand -->

本页由 GitHub Actions 在每次发版时**自动更新**，始终指向最新 Release。

## 最新版本：`v1.13.1`（2026-09-23）

👉 [查看 Release 说明与校验和](https://github.com/redtidev1918/DeviantDrop/releases/tag/v1.13.1)
...
| 平台 | 文件 | 大小 | 下载 |
|---|---|---|---|
| 通用 | `RELEASE-METADATA.json` | 1 KB | [⬇️ 下载](https://github.com/redtidev1918/DeviantDrop/releases/download/v1.13.1/RELEASE-METADATA.json) |
