...
## 最新版本：`v1.8.0`（2026-09-13）

👉 [查看 Release 说明与校验和](https://github.com/redtidev1918/deviantdrop/releases/tag/v1.8.0)
...
| 平台 | 文件 | 大小 | 下载 |
|---|---|---|---|
| 通用 | `RELEASE-METADATA.json` | 1 KB | [⬇️ 下载](https://github.com/redtidev1918/deviantdrop/releases/download/v1.8.0/RELEASE-METADATA.json) |
